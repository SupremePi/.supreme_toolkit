...
infobox="${infobox}A 3A+ PSU & a good fan is recommended for good cooling!\n"
infobox="${infobox}Options:\nPi4 at 1750/2000/2100/2147MHz \n"
infobox="${infobox}NOTE: Last Pi4 Option Requires Firmware vl805-000137ab.bin or newer!!!\n\n"
...
dialog --backtitle "Pi4 OverClocking" \
